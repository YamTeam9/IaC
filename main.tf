...
resource "azurerm_storage_account" "sg1" { 
 name      =  "StorageAccountTeam9" #add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
